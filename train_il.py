...
class NN(tf.keras.Model):
    def __init__(self, in_size, out_size):
        ...
        hidden_layer1 = tf.keras.layers.Dense(60, activation='tanh', kernel_initializer=tf.keras.initializers.GlorotUniform())(input_layer)
        hidden_layer2 = tf.keras.layers.Dense(30, activation='tanh', kernel_initializer=tf.keras.initializers.GlorotUniform())(hidden_layer1)
        output = tf.keras.layers.Dense(out_size)(hidden_layer2)
